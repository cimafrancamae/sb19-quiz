...
const SONG_POOL = {
  1: [
    ...
    { title:"Alab", emojis:"🔥❤️‍🔥✨", hint:"Single (2019) · First release after signing with Sony Music PH · Won MV of the Year at Myx Music Awards 2021 · A fiery dance-pop love song about burning desire", meaning:"Their first Sony Music single — a fiery dance-pop love song about burning desire. The MV won Music Video of the Year at the 2021 Myx Music Awards.", yt:"-tWuVqZnoL4", stream:"" },
    ...
    { title:"Nyebe", emojis:"❄️💔🌨️", hint:"Standalone single (2022) · The title names a weather phenomenon practically unheard of in the Philippines · A relationship that's gone emotionally cold", meaning:"Nyebe means 'snow' — a cold, emotionally numb breakup song about going through the motions of a relationship already frozen over.", yt:"ulCVb13Z6yk", stream:"https://lnk.to/SB19-Nyebe" },
  ...
  3: [
    ...
    { title:"Wakas", emojis:"🔚😢💙", hint:"Wakas at Simula album (2026) · The album title pairs this word with its conceptual opposite · An emotional ballad that serves as the thematic conclusion of SB19's EP trilogy era", meaning:"An emotional ballad whose title 'Wakas' (end/finish) marks both the literal and thematic conclusion of SB19's EP trilogy era. Showcases the group's extraordinary vocal abilities and heartfelt delivery.", yt:"2nxD5yku98U", stream:"https://sb19.sng.to/wakas-at-simula" },
...
const MEMBERS = [
  { name:"PABLO", color:"#9B59B6", emoji:"🎤", role:"Leader · Rapper · Producer",
    songs:[
      ...
      { title:"Presyon", emojis:"😤⚡🌊", hint:"ALON album (2024) · Opening track · The title is a Tagalog loanword borrowed from Spanish · A brazen hip-hop track about the crushing weight of expectations and demands", meaning:"A brazen opening track about the weight of expectations. Presyon means 'pressure' — delivered as raw, unflinching hip-hop.", yt:"bsw59ufwIEQ", stream:"https://lnk.to/Pablo-Alon" },
      ...
      { title:"Kumunoy", emojis:"🌊😰🕳️💡", hint:"ALON album (2024) · The title is a natural phenomenon: the harder you struggle against it, the deeper you sink · Described as one of the most emotional songs on the album · Ends on a hopeful note despite the dark imagery", meaning:"'Kumunoy' (quicksand) captures the sinking feeling of emotional despair — but the song pivots to hope. Light is glimpsed, the speaker keeps swimming, the fire within reignites. One of ALON's most emotionally resonant tracks.", yt:"kpL9kOQQTT0", stream:"" },
      ...
      { title:"Akala", emojis:"🍺😵‍💫🤦🌙", hint:"RADKIDZ single (January 2024) · Collab with Pablo's brother Josue · The title sounds like a common Tagalog word for belief or assumption, but is secretly a play on something you drink · Conceived during COVID-19", meaning:"A RADKIDZ collab between Pablo and his brother Josue — the title plays on 'alak' (alcohol), reflecting on using substances as an escape during the pandemic. The performance video 'ACT I: Shat?' shows the brothers hanging out with friends.", yt:"fGmZ8uKnHO0", stream:"" },
      ...
      { title:"Neumun", emojis:"🌌🔭🎤🌀", hint:"LAON album (2024) · Opening track · ALON and LAON are anagrams of each other — both album names evoke surviving a storm at sea · Released as a surprise double album one week after ALON", meaning:"The opening statement of LAON. The two album titles (ALON = waves, LAON = eventually) are anagrams of each other, united by a metaphor of surviving a storm at sea — violent waves rock your ship, but the storm eventually passes.", yt:"Ym44yDlRTqk", stream:"" },
      ...
      { title:"Puyat", emojis:"😴💤🔥🌃", hint:"LAON album (2024) · About grinding through exhaustion toward your dreams · Entirely in Tagalog · The title is the word Filipinos use when they've been up all night working or worrying", meaning:"'Puyat' (staying up late, sleep deprivation) is about the relentless grind — staying awake, working hard, dreaming of a better life despite exhaustion. Entirely delivered in Tagalog, with deep eyes full of aspiration.", yt:"QzA-e57xDhg", stream:"" },
      { title:"Blessed", emojis:"🙌🌟🙏💫", hint:"LAON album (2024) · A love and gratitude song — Pablo's softer, more vulnerable side · Lyrics centre on being 'blessed by you' and a 'dream come true' · Produced by RADKIDZ, mixed by Emil dela Rosa", meaning:"A tender love-and-gratitude track exploring how a meaningful connection brings stress relief and fulfilment. Stands out on LAON as Pablo's most emotionally open moment — a quiet contrast to the harder hip-hop energy elsewhere on the record.", yt:"_aOVVyxrzBQ", stream:"" },
  ...
  { name:"JOSH", color:"#E74C3C", emoji:"🎧", role:"Eldest · Rapper · Dancer",
    songs:[
      ...
      { title:"Pakiusap Lang", emojis:"🙏💔😢🎤", hint:"Single (2023) · Released April 21 · MV starred the KAIA twins · The title is a phrase Filipinos say when they're earnestly imploring someone not to leave", meaning:"A heartfelt plea about holding on to someone who's slipping away. 'Pakiusap lang' translates to 'please, I'm asking' — emotionally raw and vulnerable.", yt:"mkUB9xCZHn4", stream:"" },
      ...
      { title:"Yoko Na", emojis:"🙅‍♂️💔🚪😤", hint:"Single (2024) · Features Filipino hip-hop artist Al James · The title is a two-word phrase Filipinos say when they've finally had enough · A breaking-point collab", meaning:"A hip-hop collab with Al James about reaching a breaking point in a relationship. 'Yoko na' means 'I don't want to anymore' — raw and unfiltered.", yt:"q9-9wVu6uVE", stream:"" },
      { title:"Sumaya", emojis:"😊🎊💃🌟", hint:"Single (2024) · Released June 2 · The title is a Filipino word used as both a wish and a command · An upbeat feel-good track dedicated to anyone who needs a reminder to enjoy the moment", meaning:"Sumaya means 'to be happy' — Josh delivers a bright, danceable feel-good track dedicated to anyone who needs a reminder to just enjoy the moment.", yt:"ogjjgZ2k1OE", stream:"" },
  ...
  { name:"STELL", color:"#3498DB", emoji:"🎼", role:"Main Vocalist · Choreographer",
    songs:[
      ...
      { title:"Anino", emojis:"👤❤️🌑", hint:"Solo single (2024) · A ballad about a love so selfless it stays invisible · The title describes what silently follows you wherever you go on a sunny day", meaning:"A stirring ballad about selfless love that stays in the shadows. Anino means 'shadow' — the song promises to endure everything without needing recognition.", yt:"mNO53zv5J34", stream:"" },
      { title:"Di Ko Masabi", emojis:"🤐💛🎻😶", hint:"Room EP (2024) · Features a prominent Filipino actress · Composed by National Artist Ryan Cayabyab · The title is the phrase you say when feelings are too overwhelming to put into words", meaning:"A stunning collab with actress Nour Hooshmand, composed by National Artist Ryan Cayabyab. 'Di Ko Masabi' — about feelings too overwhelming to put into words.", yt:"Exk61eDuOCY", stream:"" },
  ...
  { name:"KEN (FELIP)", color:"#1ABC9C", emoji:"🌙", role:"Main Dancer · Rapper · Producer",
    songs:[
      ...
      { title:"foes", emojis:"⚔️🎸🌑🤜", hint:"7Sins album (2024) · Opening track · Features Stell and Josh · FELIP's personal favorite on the album — he has said he's 'really fond of the metal genre' · Grand theatrical overture into a menacing guitar intro", meaning:"The grand opening of 7Sins — featuring Stell and Josh in FELIP's favorite genre: metal. A soaring riff crashes into menacing rock and electronic elements. FELIP's stated favorite on the album, it sets the tone for the entire exploration of human failings.", yt:"6ZfKD-2SWwQ", stream:"" },
      ...
      { title:"wrath", emojis:"😡🔥💥⚡", hint:"7Sins album (2024) · Track 3 · Hard rock/rap · Contains the now-iconic lyric 'I chose violence today' · Produced and mixed by Luke April and FELIP at Monostery Studios", meaning:"FELIP channels unfiltered rage — the iconic line 'I chose violence today' became the track's calling card. Produced with Luke April, it pairs deep booming vocals with a menacing synth-infused riff for one of 7Sins' heaviest moments.", yt:"3DRL0-R5sQk", stream:"" },
      ...
      { title:"pride", emojis:"🦁👑😤🏆", hint:"7Sins album (2024) · Track 5 · FELIP said: 'I'm a proud Bisaya, so it was fun to really just go all out on this track' · About refusing to let others dictate your life · Contains explicit content", meaning:"An autobiographical hip-hop declaration rooted in Bisaya cultural pride. FELIP turns critics' negativity into fuel — the sin of pride reframed as self-respect and regional identity. One of his most personal tracks on 7Sins.", yt:"VrVbc0n7NrM", stream:"" },
      ...
      { title:"ache", emojis:"💙🌅🩹✨", hint:"7Sins album (2024) · Closing gospel/ballad · FELIP's personal favorite on the album AND the hardest to make — he cried while recording and you can hear his voice crack in the final take · Features background vocals by the Palabyab siblings", meaning:"The healing conclusion to 7Sins — a gospel-inflected ballad where FELIP bares everything. He cried during recording and chose to keep the voice cracks in, making the emotion audible. The lyric 'all my wounds will find light' closes the album's journey through human failings with hard-won hope.", yt:"tf6HUSTuylQ", stream:"" },
    ]},
