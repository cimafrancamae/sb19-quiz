...
const MEMBERS = [
  ...
  { name:"KEN (FELIP)", color:"#1ABC9C", emoji:"🌙", role:"Main Dancer · Rapper · Producer",
    songs:[
      ...
      { title:"Rocksta", emojis:"🎸🤘🌟🔊", hint:"COM•PLEX EP (2023) · Lead pre-release single · Features FELIP's most guitar-forward production · Title blends two words", meaning:"The lead single off COM•PLEX — FELIP's rock-leaning side in full force. 'Rocksta' blends 'rock' and 'star,' a declaration of his range beyond R&B.", yt:"", stream:"" },
      ...
      { title:"Fake Faces", emojis:"🎭😠🔥🤥", hint:"Single (2024) · Won Best Rock Video at MYX Music Awards 2024 · Trended #12 on YouTube Philippines · A pop-rock call-out track", meaning:"FELIP's angriest release — a pop-rock explosion calling out fake people and two-faced behavior. Won Best Rock Video at MYX 2024.", yt:"", stream:"" },
    ]},
  { name:"JUSTIN", color:"#F39C12", emoji:"🎨", role:"Visual · Vocalist · Creative Director",
    songs:[
      { title:"Sunday Morning", emojis:"☀️🌿🎸😌", hint:"Cover single (2024) · Originally by an American pop-rock band · Filmed in the mountains of Benguet · Officially released on streaming April 14", meaning:"Justin's tender cover of Maroon 5's Sunday Morning, filmed among the misty mountains of Atok, Benguet. A stripped-back acoustic interpretation spotlighting his gentle, sincere vocals.", yt:"", stream:"" },
