...
const SONG_POOL = {
  ...
  2: [
    ...
    { title:"Ready", emojis:"🎬🔥🌍🎤", hint:"Collab (2024) · Features a founding member of a legendary American group · MV directed by a director known for Katy Perry and Britney Spears · SB19's biggest international collab to date", meaning:"A high-energy collab with apl.de.ap of the Black Eyed Peas. The house-party MV was directed by Ben Mor and filmed in Manila, designed to announce SB19 to international audiences.", yt:"", stream:"" },
  ...
  3: [
    ...
    { title:"Toyfriend", emojis:"🤝🎵🌸😊", hint:"Wakas at Simula album (2026) · Collab with a Japanese boy group · Described as 'cool, easy, and warm' · Debuted live at a showcase in Yokohama before official release", meaning:"SB19's first official collab with a Japanese group — BE:FIRST. A feel-good pop track described as 'cool, easy, and warm,' performed live at DUNK Showcase in K-Arena Yokohama.", yt:"45yoTfV8Nn0", stream:"" },
    { title:"Everblack", emojis:"🌑🎸🔮⚡", hint:"Wakas at Simula album (2026) · One of the more experimental tracks on the album · Described as 'sonically daring' · Pushes into darker sonic territory", meaning:"One of the more experimental tracks from SB19's second studio album — 'sonically daring' and refreshingly dark, pushing into heavier, more complex territory.", yt:"qhsxCW58dPM", stream:"" },
    { title:"Wakas", emojis:"🔚🌸😢💙", hint:"Wakas at Simula album (2026) · Title means 'end' in Filipino · An emotional ballad that serves as the thematic conclusion of SB19's EP trilogy era", meaning:"An emotional ballad whose title 'Wakas' (end/finish) marks both the literal and thematic conclusion of SB19's EP trilogy era. Showcases the group's extraordinary vocal abilities and heartfelt delivery.", yt:"2nxD5yku98U", stream:"" },
...
const MEMBERS = [
  { name:"PABLO", color:"#9B59B6", emoji:"🎤", role:"Leader · Rapper · Producer",
    songs:[
      ...
      { title:"The Boy Who Cried Wolf", emojis:"🐺😔🐑", hint:"ALON album (2024) · Retells a famous Aesop's fable from the perspective of the animal, not the shepherd boy", meaning:"Pablo flips the classic fable — taking the wolf's perspective, feeling misjudged. A deeply personal reflection on being misunderstood.", yt:"rg-DBZdd6i4", stream:"https://lnk.to/Pablo-Alon" },
      { title:"Determinado", emojis:"💪🏽🔥🎯", hint:"Single (2024) · Collab with a family member who shares his production alias · Spanish title meaning 'determined'", meaning:"A hard-hitting declaration of grit — a collab with his brother Josue under their RADKIDZ alias.", yt:"SYQyP9aH7vs", stream:"https://lnk.to/Pablo-Determinado" },
      { title:"Micha", emojis:"🏆💥🙌", hint:"LAON album (2024) · Closing hype track of a two-album project · 'Boss battle' production with chorale flourishes", meaning:"The hype finale of LAON — a rallying cry for anyone taking a leap of faith, with rapidfire rap and epic chorale energy.", yt:"", stream:"https://lnk.to/Pablo-Laon" },
  ...
  { name:"JOSH", color:"#E74C3C", emoji:"🎧", role:"Eldest · Rapper · Dancer",
    songs:[
      ...
      { title:"Silent Cries", emojis:"😢🌃🏘️🎸", hint:"Lost & Found album (2024) · Pre-release single · Josh revisits places from his childhood, both good and bad memories · Guitar-driven emo-adjacent track", meaning:"A melancholic, guitar-driven track where Josh revisits the places that shaped him. Lyrics capture being lost but not wanting to be found — 'drowning in the dark, wish I could find the light through silent cries.'", yt:"", stream:"" },
