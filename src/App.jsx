...
const SONG_POOL = {
  ...
  3: [
    ...
    { title:"No Stopping You", emojis:"🏃‍♂️💨🎬🔥", hint:"OST (2021) · Written for a Filipino streaming film · Remixed with a female OPM artist named after a day of the week", meaning:"Written for the Filipino film Love at First Stream — a high-octane anthem about unstoppable momentum. The remix with Jayda Avanzado extended its reach.", yt:"ffh0ojPU27k", stream:"https://lnk.to/SB19-NoStoppingYou" },
    { title:"Win Your Heart", emojis:"🏆💐❤️", hint:"Special single (2022) · Official theme of a national beauty pageant · Written as a competitive courtship song", meaning:"A charming, competitive love song written as the official theme of Binibining Pilipinas 2022.", yt:"ffh0ojPU27k", stream:"https://lnk.to/SB19-WinYourHeart" },
    { title:"Love Goes", emojis:"💘🛤️🌅", hint:"Get In The Zone album (2020) · Also released as an EDM remix on the same album · About where a love eventually leads", meaning:"A bittersweet track about a love slowly fading. Released in both original and EDM versions on their debut album.", yt:"C9jkWKNEGX8", stream:"https://lnk.to/SB19-GetInTheZone" },
    { title:"KALAKAL", emojis:"🤝💸🎤😤", hint:"Collab (2024) · Features OPM rap royalty alongside Ken's Bisaya verses · Title is a Filipino market term for the exchange of goods", meaning:"A gritty collab with Gloc-9 about trade and worth. Ken flexes Bisaya pride through his verses. Kalakal means 'trade' or 'barter.'", yt:"ffh0ojPU27k", stream:"https://lnk.to/SB19-Kalakal" },
    { title:"Moonlight", emojis:"🌕✨🌏🎶", hint:"International collab (2024) · Three artists from three different countries · Bridges P-pop, Western pop, and Mandopop in one track", meaning:"A dreamy collab with Ian Asher and Terry Zhong. A moonlit romantic crossover bridging three music scenes — P-pop, Western pop, and Mandopop.", yt:"ffh0ojPU27k", stream:"https://lnk.to/SB19-Moonlight" },
    { title:"Wag Mong Ikunot Ang Iyong Noo", emojis:"😠🤚😮‍💨💆", hint:"Get In The Zone album (2020) · Longest song title in their discography · The title is a literal physical instruction about a facial expression", meaning:"A lighthearted feel-good track. The title literally means 'Don't furrow your brow' — a playful Filipino reminder to stop worrying.", yt:"C9jkWKNEGX8", stream:"https://lnk.to/SB19-GetInTheZone" },
